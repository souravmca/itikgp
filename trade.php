		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">Trades Affiliated to NCVT and SCVT</b><br><br>
                                                                                <table id="gradient-style" summary="Meeting Results">
                                                                                    <thead>
                                                                                        <tr>
                                                                                                        <th>Name of the Trade (linked to the respective syllabus with DGET website)</th>
                                                                                                        <th>No. of units</th>
                                                                                                        <th>Shifts Runnig(I/II/III)</th>
                                                                                                        <th>Seating Capacity per unit</th>
                                                                                                        <th>Total seating capacity</th>
                                                                                                        <th>Affiliation Date/copy of DGET order Link (SCANED)</th>
                                                                                                </tr>
                                                                                    </thead>
