		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">Funds Status</b><br><br>
                                                                            i) Details of Placement Cell<br>
                                                                            ii) Placement record of the trainees during last five years. (Year-Wise)<br><br>
                                                                            <table id="gradient-style" summary="Meeting Results">
                                                                                <thead>
                                                                                    <tr style="font-size:14px; line-height:28px;">
                                                                                                    <th scope="col" abbr="Starter">Budget Allotted</th>
                                                                                                    <th scope="col" abbr="Medium">Assisted Scheme (DGET/World Bank, etc)</th>
                                                                                                    <th scope="col" abbr="Business">Budget used (Hyperlink to Relevant Central/State Directorate Head)</th>
                                                                                                </tr>
