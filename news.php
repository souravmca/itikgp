		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">News &amp; Events</b><br><br>
                                                                                <!--News-->      
                                                                                ...
                                                                                <table cellpadding="4">
                                                                                <tbody><tr>
                                                                                <td><div class="circle color-1 color1-box-shadow">25th Sept</div></td>
                                                                                <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in venenatis enim... Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in venenatis enim... Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in venenatis enim...</td>
                                                                                </tr>
                                                                                </tbody></table>
                                                                                </li>
                                                                                <li class="news-item">
