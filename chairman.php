...
Contact-7001273957</h3>
  ...
  <ul style="width:250px;">
      ...
      </ul><select class="selectnav" id="selectnav1"><option value="">-Navigation-</option><option value="http://www.kpiti.org/index.php"> Home</option><option value="http://www.kpiti.org/chaiman.html#"> About</option><option value="http://www.kpiti.org/about.html">- Introduction of the institute</option><option value="http://www.kpiti.org/chaiman.html" selected="">- Chairman &amp; Members</option><option value="http://www.kpiti.org/faculty_list.php">- Faculty (Technical Staff)</option><option value="http://www.kpiti.org/state.html">- State Directorate</option><option value="http://www.kpiti.org/administrative.html">- Administrative Staff</option><option value="http://www.kpiti.org/chaiman.html#"> Information</option><option value="http://www.kpiti.org/trade.html">- Trades Affiliated to NCVT and SCVT</option><option value="http://www.kpiti.org/summary1.html">- Summary of Trades 1</option><option value="http://www.kpiti.org/summary2.html">- Summary of Trades 2</option><option value="http://www.kpiti.org/court.html">- Court Case and Status</option><option value="http://www.kpiti.org/right.html">- Right to Information</option><option value="http://www.kpiti.org/chaiman.html#"> Infrastucture</option><option value="http://www.kpiti.org/libary.html">- Library</option><option value="http://www.kpiti.org/sport.html">- Sports/Recreation</option><option value="http://www.kpiti.org/curriculam.html">- Extra Curricular activities</option><option value="http://www.kpiti.org/chaiman.html#"> Admission</option><option value="http://www.kpiti.org/application_form.html">- Application Format</option><option value="http://www.kpiti.org/admision.html">-  Admission Criteria</option><option value="http://www.kpiti.org/ratings.html">- Rating of Institute</option><option value="http://www.kpiti.org/grievance.html">- Grievance Redressal Mechanism</option><option value="http://www.kpiti.org/rules.html">- General Rules &amp; Regulations</option><option value="http://www.kpiti.org/chaiman.html#"> Performance</option><option value="http://www.kpiti.org/quality.html">- Quality Monitoring</option><option value="http://www.kpiti.org/achievement.html">- Achievements by Trainees</option><option value="http://www.kpiti.org/overall_result.php">- Overall Results</option><option value="http://www.kpiti.org/certificate.html">- Certificates issued to Trainees</option><option value="http://www.kpiti.org/placement.html">- Placement</option><option value="http://www.kpiti.org/gallery.html"> Gallery</option><option value="http://www.kpiti.org/fund.html"> Fund Status</option><option value="http://www.kpiti.org/news.html"> News Events</option><option value="http://www.kpiti.org/order.html"> Order Issued</option><option value="http://www.kpiti.org/contact.html"> Contact</option></select>
                                    </nav>
				</div>
			</div>
		</section>
		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">Chairman &amp; Members</b><br><br>
                                                                            ...
                                                                            <ul>
                                                                                    ...
                                                                                    <h3>PRESIDENT	</h3>
                                                                                            <div>
                                                                                                ...
                                                                                                <div class="name_l">Address </div>
                                                                                                <div class="name_l">&nbsp;</div>
                                                                                                <div class="name_l">Mobile No : -*</div>
                                                                                                <div class="name_l">UID No: -- </div>
                                                                                                <div class="name_l">Society / Trust/company </div>

                                                                                                </div>
                                                                                                <div style="float:left; width:400px;">
                                                                                                <div class="name"> Suman Achariya</div>
                                                                                                <div class="name">Subhas Pally,Word no.19,Kharagpur.Pashchim Medinipur,pincode721301</div>
                                                                                                <div class="name">9800098555</div>
                                                                                                <div class="name">  </div>
                                                                                                <div class="name">------ </div>
