		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">Certificates issued to Trainees</b><br><br>
                                                                                Year wise (3 years record) :<br><br>
                                                                                <!--faculty--> 
                                                                                <table id="gradient-style" summary="Meeting Results">
                                                                                    ...
                                                                                    <thead>    
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="col">February, 2016</th>
                                                                                            <th scope="col"> August, 2016</th>
                                                                                            <th scope="col">February, 2016</th>
                                                                                            <th scope="col">August, 2016</th>
                                                                                            <th scope="col">February, 2016</th>
                                                                                            <th scope="col">August, 2016</th>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                                <th scope="row">No. of Trainees appeared</th>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                        ...
                                                                                        <tr>
                                                                                                <th scope="row">No. of Trainees passed</th>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                        ...
                                                                                        <tr>
                                                                                                <th scope="row">No. of NTCs issued</th>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                        ...
                                                                                        <tr>
                                                                                                <th scope="row">No. of NTCs pending</th>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
                                                                                            <td> </td>
