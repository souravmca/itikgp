		...
		<section id="content_area">
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
                                                                            <b style="font-size:24px; color:#09C; padding:10px 0 0 0px;">Sports/Recreation</b><br><br>
                                                                            <b>Sports/Recreation (Brief information on Hardware and Software) :</b> Out door (Football, Cricket, Volleyball, 	
                                                                            Kabadi, Kho-Kho)  &amp; Indoor (Cram, Computer Game) game facility &amp; Singing, Dancing, Drama, Recitation.
                                                                            <br><br>
                                                                            <b>Sports/Recreation (Brief information on Facilities Available):</b> Availability of Play Ground in fornt of Institution impress the trainee for those event. Cricket, Football, Volleyball , Kabadi , Kho-Kho, Cram, Singing , Dancing , Drama, Recitation , Computer Game.
